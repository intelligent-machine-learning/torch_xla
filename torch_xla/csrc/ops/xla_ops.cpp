...
const OpKindWrapper xla_scaled_dot_product_attention(
    "xla::scaled_dot_product_attention");
extern const OpKindWrapper xla_scaled_dot_product_attention_backward(
    "xla::scaled_dot_product_attention_backward");
}  // namespace torch_xla
